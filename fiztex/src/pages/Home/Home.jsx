    ...
    <div className='home-page'>
        <header className='h-100 min-vh-100 d-flex align-items-center text-light'>
            <div className='container d-flex flex-column align-items-center'>
                <h1 className='text-center fw-semibold'>FIZTEX</h1>
                ...
                <div className='d-flex flex-column flex-sm-row align-items-center mt-md-3'>
                    <Link to="/courses">
                        <button type='button' className='btn btn-danger btn-lg mx-0 mx-sm-2 my-2 my-sm-0' style={{ backgroundColor: "#214A97", borderColor: "#214A97", color: "#fff" }}>Our Courses</button>
                    </Link>
                    <Link to="/contact">
            ...
            <div className="container">
                <div className='row d-flex align-items-center justify-content-around'>
                    <div className='col-lg-5'>
                        ...
                        <Link to="/courses">
                            <button type='button' className='btn btn-danger btn-lg mx-0 mx-sm-2 my-2 my-sm-0' style={{ backgroundColor: "#214A97", borderColor: "#214A97", color: "#fff" }}>Learn More</button>
                        </Link>
                    </div>
        ...
        <div className='blog-section text-light py-5'>
            <div className='container d-flex flex-column align-items-center'>
                ...
                <Link to="/blog">
                    <button type='button' className='btn btn-danger btn-lg mt-5' style={{ backgroundColor: "#214A97", borderColor: "#214A97", color: "#fff" }}>Read More Blogs</button>
                </Link>
            </div>
        </div>
    </div>
